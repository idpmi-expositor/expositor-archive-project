...
from pipeline_classification import load_profile  # noqa: E402
...
class TestSectionExtractor(unittest.TestCase):
    ...
    def setUp(self) -> None:
        """Load the maestro profile for tests."""
        self.maestro_profile = load_profile("maestro")
        self.section_aliases = self.maestro_profile.get("section_aliases", {})
    ...
    def test_volume_46_lesson_22_extraction(self) -> None:
        ...
        extracted = extract_sections_for_segment(
            lines, source_text_path, lesson_22_segment, self.section_aliases
        )
        ...
        self.assertIn("teacher_notes", extracted, "teacher_notes should be extracted")
    ...
    def test_volume_45_lesson_01_summary_extraction(self) -> None:
        ...
        extracted = extract_sections_for_segment(
            lines, source_text_path, lesson_01_segment, self.section_aliases
        )
